...
var (
	...
	// ErrTokenInvalid 表示 request 缺少 Authorization
	ErrAuthorizationNotFound = &Errno{HTTP: 401, Code: "AuthFailure.ErrAuthorizationNotFound", Message: "Request header cannot find authorization."}
)
